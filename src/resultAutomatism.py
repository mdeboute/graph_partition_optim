...
isInitSol = (
    doGradient or doBetterGradient or doTabou or doTabouNSwap or doRC or doNSwapRC
)
...
def do(path, k, neighborhoodSize, iterMax, timeOut, tabuSize):
    ...
    if doTabouNSwap:
        ...
        print(
            "\nTabou nSwap found the solution : ",
            sol,
            " with a cost of ",
            solCost,
            " in ",
    ...
    if doGradient:
        t = time.time()
        sol, solCost = gradientDescent(
            initialSolution, initialSolutionCost, timeOut, False, neighborhoodSize
        )
        print(
            "\nGD found the solution : ",
            sol,
            " with a cost of ",
            solCost,
            " in ",
    ...
    if doBetterGradient:
        t = time.time()
        sol, solCost = betterGradientDescent(
            initialSolution, initialSolutionCost, timeOut, False, neighborhoodSize
        )
        print(
            "\nbetterGD found the solution : ",
            sol,
            " with a cost of ",
            solCost,
            " in ",
    ...
    if doRC:
        t = time.time()
        sol, solCost = simulatedAnnealing(
            initialSolution,
            initialSolutionCost,
            swapNodes(initialSolution),
            iterMax * graph.getNbVertices(),
            timeOut,
            False,
            neighborhoodSize,
